...
class HybridGuidedVAETrainer():
    ...
    def tsne_project_new(self, lats, tgts): ## intended to add an index on every 50 dot, not useful for zero-shot/generalization 
        """
        ...
        colors =  [
            "#eced0f", "#bcfb1e", "#7afb1e", "#000000", "#f8b51e",
        ...
        for i in range(self.params['num_classes']):
            ...
            #############Add labels for every 50th dot ################## By Ni, not useful in the end
    ...
    def tsne_project(self, lats, tgts):
        ...
        """        
        from sklearn.manifold import TSNE
        ### colors for generalization:
        ### Now: 15-hall-"#000000"-black; 3-printerroom-"#3ced1e"-green; 14-office-"#ea191e"-red; 0-passageway-"#eced0f"-yellow   

        colors =  [
            "#eced0f", "#bcfb1e", "#7afb1e", "#3ced1e", "#d06b7a",  
            "#d5ce5f", "#82ce7a", "#32b569", "#f8611e", "#f8b51e", 
            "#756bc6", "#2561b5", "#5e19b5", "#b01969", "#ea191e", "#000000"  
        ]

        ### original colors for training: 
        '''
        colors =  [
...
if __name__=="__main__":
    ...
    dataset_path_test = '/Users/nwang/0_test_environments/hall_samples/' #'/Users/nwang/test_environments/1st_sample/'
